...
var TilesSearchHelper = (function () {
    function TilesSearchHelper() {
    }
    TilesSearchHelper.findNeighboringTiles = function (coll, row, matchTiles, tiles) {
    ...
    TilesSearchHelper.getIndex = function (c, r, tiles) {
        var index = 0;
    ...
    TilesSearchHelper.getTilesToBeMoved = function (matchTiles, tiles) {
        var arr = [];
    ...
    TilesSearchHelper.getMovementDistance = function (movedTiles, matchTiles) {
        return this.getCountTilesMove(movedTiles, matchTiles);
    };
    TilesSearchHelper.getNonDiagonalMatches = function (c, r, tiles) {
        var arr = [];
    ...
    TilesSearchHelper.findMatchingTilesByCollRow = function (c, r, tiles) {
    ...
    TilesSearchHelper.getDistinctTiles = function (moveTiles) {
        var uniqueArray = moveTiles.filter(function (elem, pos) {
            return moveTiles.indexOf(elem) == pos;
        });
        return uniqueArray;
    };
    TilesSearchHelper.getCountTilesMove = function (movedTiles, matchTiles) {
        var _this = this;
        var arr = [];
    ...
    TilesSearchHelper.getCountMatchTiles = function (matchTiles, mvdTile) {
        return matchTiles.filter(function (mchTile) { return mchTile.getColl() === mvdTile.getColl()
            && mvdTile.getRow() < mchTile.getRow(); }).length;
    };
    return TilesSearchHelper;
}());
exports.TilesSearchHelper = TilesSearchHelper;
